...
import { SwaggerResponse } from "./config.js";
...
import {
  ...
  BuildOrderHeaderRequest,
  BuildOrderHeaderResponse,
...
/**
 *
 * Gets a single EntireItem by Id. (Errors if not found).
 */
...
/**
 *
 * Gets specific EntireItems by Ids. (Errors if any not found).
 */
...
/**
 *
 * Gets EntireItems matching the given filter.
 */
...
export const postOrderV1BuildOrderHeader = (
  requestBody: BuildOrderHeaderRequest,
  configOverride?: AxiosRequestConfig
): Promise<SwaggerResponse<BuildOrderHeaderResponse>> => {
  return Http.postRequest(
    postOrderV1BuildOrderHeader.key,
    undefined,
    requestBody,
    undefined,
    overrideConfig(_CONSTANT0, configOverride)
...
/** Key is end point string without base url */
postOrderV1BuildOrderHeader.key = "/webapi/Order/v1/BuildOrderHeader";
...
/** Key is end point string without base url */
postOrderV1BuildOrderLines.key = "/webapi/Order/v1/BuildOrderLines";

/**
 *
 * Creates a new order in Open status.
 */
export const postOrderV1CreateOrder = (
  requestBody: CreateOrderRequest,
  configOverride?: AxiosRequestConfig
): Promise<SwaggerResponse<CreateOrderResponse>> => {
  return Http.postRequest(
    postOrderV1CreateOrder.key,
    undefined,
    requestBody,
    undefined,
    overrideConfig(_CONSTANT0, configOverride)
...
/** Key is end point string without base url */
postOrderV1CreateOrder.key = "/webapi/Order/v1/CreateOrder";

/**
 *
 * Gets a single Order.
 */
export const postOrderV1GetOrder = (
  requestBody: GetOrderRequest,
  configOverride?: AxiosRequestConfig
): Promise<SwaggerResponse<GetOrderResponse>> => {
  return Http.postRequest(
    postOrderV1GetOrder.key,
    undefined,
    requestBody,
    undefined,
    overrideConfig(_CONSTANT0, configOverride)
...
/** Key is end point string without base url */
postOrderV1GetOrdersByFilter.key = "/webapi/Order/v1/GetOrdersByFilter";
...
/** Key is end point string without base url */
postOrderV1SaveOrder.key = "/webapi/Order/v1/SaveOrder";
